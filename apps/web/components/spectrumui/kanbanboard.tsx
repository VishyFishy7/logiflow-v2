    ...
    tasks: [
      {
        ...
        priority: "high",
        assignee: { name: "Sarah Chen", avatar: "/avatars/people/02.jpg" },
        tags: ["Design", "System"],
        dueDate: "2024-01-15",
        attachments: 3,
        comments: 7,
      },
      {
        ...
        priority: "medium",
        assignee: { name: "Alex Rivera", avatar: "/avatars/people/04.jpg" },
        tags: ["Research", "UX"],
        dueDate: "2024-01-18",
        comments: 4,
      },
    ...
    tasks: [
      {
        ...
        priority: "high",
        assignee: { name: "Jordan Kim", avatar: "/avatars/people/06.jpg" },
        tags: ["Mobile", "UI"],
        attachments: 8,
        comments: 12,
      },
    ...
    tasks: [
      {
        ...
        priority: "medium",
        assignee: { name: "Maya Patel", avatar: "/avatars/people/09.jpg" },
    ...
    tasks: [
      {
        ...
        priority: "low",
        assignee: { name: "Chris Wong", avatar: "/avatars/people/10.jpg" },
        tags: ["Marketing", "Web"],
        attachments: 2,
        comments: 8,
      },
