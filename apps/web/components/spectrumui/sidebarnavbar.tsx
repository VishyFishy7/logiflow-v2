...
import {
  ...
  CollapsibleContent,
  CollapsibleTrigger,
} from "@/components/spectrumui/collapsible";
import { ScrollArea } from "@/components/spectrumui/scroll-area";
import {
  ChevronRight,
  Home,
  Menu,
      ...
      >
        ...
        <ScrollArea className="flex-1">
          <nav className="p-2">
            ...
            <Collapsible>
              <CollapsibleTrigger render={<Button variant="ghost" className="w-full justify-start" />}><Package className="mr-2 h-4 w-4" />{isOpen && (
                                              <>
                                                Products
