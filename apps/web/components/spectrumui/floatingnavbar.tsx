  ...
  return (
    ...
    <div className=" bottom-6 left-0 right-0 flex justify-center">
      <nav className="flex items-center justify-center space-x-4 rounded-full border bg-background p-2 shadow-lg">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger render={<Button size="icon" className="rounded-full bg-primary text-primary-foreground" />}><Plus className="h-5 w-5" /><span className="sr-only">Add</span></DropdownMenuTrigger>
